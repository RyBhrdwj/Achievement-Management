      ...
      <style>
        {`
          ...
          .animate-slideInFromTopRight {
            animation: slideInFromTopRight 0.5s ease-in-out forwards;
          }
        `}
      </style>
      ...
      >
        <div className='flex flex-col items-center'>
          ...
          <div className='w-full'>
            <NavLink
              to="/"
              className={`block text-white text-lg py-4  px-4 rounded-md bg-blue-900 w-full text-center mb-4 ${isMenuOpen ? 'animate-slideInFromTopRight' : ''}`}
              onClick={() => {
                handleClick(0);
                toggleMenu();
              }}
