      ...
      {activeStep === steps.length ? (
        <React.Fragment>
          <div className="mt-4">
            ...
            <h2 className="mt-2 text-xl">Name of the event: {details.name}</h2>
            <h2 className="mt-2 text-xl">Date: {details.date}</h2>
            <h2 className="mt-2 text-xl">Event Type: {details.type}</h2>
            <p className="mt-2 text-lg">Mode: {details.mode}</p>
            <p className="mt-2 text-lg">Result: {details.result}</p>
          </div>
          ...
          {activeStep === 0 && (
            <div className="grid gap-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <fieldset className="flex flex-col space-y-2">
                  <label className={`text-lg font-medium ${details.type === 'other' ? 'text-gray-700' : 'text-gray-400'}`}>
                    Other:
                  </label>
                  <input
                    type="text"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <fieldset className="border-2 border-gray-300 p-4 rounded-lg col-span-1 md:col-span-2">
              ...
              <div className="relative flex justify-center items-center border-dashed border-2 border-gray-300 p-14 rounded-md">
                ...
                {details.proofUrl ? (
                  <div className='relative'>
                    <img src={details.proofUrl} alt="Proof Preview" className="w-96" />
                    <button title='delete' className='absolute top-0 right-0 p-2 m-2 bg-red-500 shadow rounded-full' onClick={() => setDetails({ ...details, proof: null, proofUrl: '' })}>
